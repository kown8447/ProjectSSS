               ...
               .each(
                     function(index, obj) {
                        var replyTag = '<div id="replyView_'
                              ...
                              + '" style="color:green">'
                              + obj.member_id
                              + '</div></td></tr><span style="float:right"><button type="button" value="cmtUpdate_'
                              + (index + 1)
                              + '" id="cmtUpdate_'
                              + (index + 1)
                              + '" class="cmtEdit btn-link btn-sm" name="cmtEdit">수정</button><button type="button" id="cmtDelete_'
                              + (index + 1)
                              + '" value="cmtDelete_'
                              + (index + 1)
                              + '" class="cmtDel btn-link btn-sm" name="cmtDel" >삭제</button></span><tr><td><textarea rows="2" cols="100" class="cmtContent form-control" id="cmt_content_'
                              + (index + 1)
                              + '"readonly="readonly" style="resize: none;background-color: white;border: 0">'
                              + obj.reply_content
                              + '</textarea></td></tr></table></div><hr>';
   ...
   function cmtdeleteSetting() {
    ...
    function cmtUpdateSetting() {
       ...
       $('.cmtEdit').click(function() {
          ...
          $('.cmtContent').attr("style", "display : inline; resize: none;background-color: white;border: 0;");
          ...
          var updateTool=
             '<textarea rows="2" cols="100" class="form-control" style="resize: none;background-color: white;border: 0" id="updateCmtContent" value="">'+$('#cmt_content_'+cmtIndex).text() +'</textarea><input type="button" id="updateCmtUpdate" class="btn-link" style="font-size:5pt" value="확인"><input type="button" id="updateCmtCancel" class="btn-link" style="font-size:5pt" value="취소">'
