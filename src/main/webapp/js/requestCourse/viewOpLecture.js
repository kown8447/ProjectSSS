		...
		$.ajax(
				{
					...
					dataType:"json",
					success:function(data){
						var text="<table class='table table-bordered table-hover'><tr style='background-color:gray'><th style='text-align: center'>구분</th><th style='text-align: center' id='order_subject_name' class='asc'><font style='color:blue'>강의 이름(클릭시 정렬)</font></th><th style='text-align: center'>시간</th><th style='text-align: center' id='order_subject_name' class='asc'><font style='color:red'>지도 교수(클릭시 정렬)</font></th><th style='text-align: center'>강의 계획서</th><th style='text-align: center'>모집 인원</th></tr>";
	...
	$.ajax(
		{
			...
			success:function(data){
				...
				if($('#order_subject_name').attr('class')=='asc'){
					text="<table class='table table-bordered table-hover'><tr style='background-color:gray'><th style='text-align: center'>구분</th><th style='text-align: center' id='order_subject_name' class='desc'><font style='color:blue'>강의 이름(클릭시 정렬)</font></th><th style='text-align: center'>시간</th><th style='text-align: center' id='order_professor_name' class='desc'><font style='color:red'>지도 교수(클릭시 정렬)</font></th><th style='text-align: center'>강의 계획서</th><th style='text-align: center'>모집 인원</th></tr>";
				}
				else{
					text="<table class='table table-bordered table-hover'><tr style='background-color:gray'><th style='text-align: center'>구분</th><th style='text-align: center' id='order_subject_name' class='asc'><font style='color:blue'>강의 이름(클릭시 정렬)</font></th><th style='text-align: center'>시간</th><th style='text-align: center' id='order_professor_name' class='asc'><font style='color:red'>지도 교수(클릭시 정렬)</font></th><th style='text-align: center'>강의 계획서</th><th style='text-align: center'>모집 인원</th></tr>";
				}
