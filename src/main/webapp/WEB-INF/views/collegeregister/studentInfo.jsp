...
<div class="row" style="width: 80%; margin: auto;">
	<div class="form-inline">
		<img src="${pageContext.request.contextPath}/profiles/${student.member_picture}" class="img-rounded"
			style="height: 150px; width: 150px; border: 1px solid;float: left;">

	<table class="table table-bordered" style="width: 80%;height: 150px; ">
		<tr>
			<th
				style="text-align: center; background-color: #F8F4EC; width: 12%;">학번</th>
			<td style="text-align: center;">${student.student_code}</td>
			<th
				style="text-align: center; background-color: #F8F4EC; width: 12%;">성명</th>
			<td style="text-align: center; width: 30%;">${student.member_name}</td>
		</tr>
		<tr>
	...
	<table class="table table-bordered">
		<tr>
			<th
				style="text-align: center; background-color: #F8F4EC; width: 20%;">대학</th>
			<td style="text-align: center;">${mainMajor.college_name}</td>
			<th
				style="text-align: center; background-color: #F8F4EC; width: 20%;">입학년도</th>
		...
		<tr>
			...
			<th style="text-align: center; background-color: #F8F4EC;">잔여
				휴학학기</th>
			<td style="text-align: center;">${8-absenceCount}</td>
		</tr>
		<tr>
			<th style="text-align: center; background-color: #F8F4EC;">총
				이수학점</th>
		...
		<tr>
			...
			<td colspan="3" style="text-align: center;"><c:if
					test="${doubleMajor!=null}">${doubleMajor.department_name}</c:if></td>
		</tr>
	</table>
</div>
