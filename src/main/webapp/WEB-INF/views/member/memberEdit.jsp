			...
			<tbody>
				<tr>
					<th class="col-sm-3" rowspan="10" style="display: table-cell; vertical-align: middle;">
						<div id="list" style="text-align: center;">
							<img src="../profiles/${member.member_picture}" class="img-rounded" style="height: 150px; border: 1px solid #000;">
						</div> <br> 
					...
					<th class="col-sm-3">
						<input type="text" name="member_name" id="member_name" class="form-control" value="${member.member_name}" readonly />
					</th>
				...
				<tr>
					<se:authorize access="hasRole('ROLE_STUDENT')">
						...
						<td colspan="3">
							<input type="text" name="student_code" id="student_code" value="${member.student_code}" class="form-control" readonly /></td>
					</se:authorize>
					<se:authorize access="hasRole('ROLE_PROFESSOR')">
						<td style="display: table-cell; vertical-align: middle;"><b>교수코드</b></td>
						<td colspan="3">
							<input type="text" name="professor_code" id="professor_code" value="${member.professor_code}" class="form-control" readonly /></td>
					</se:authorize>
					<se:authorize access="hasRole('ROLE_ADMIN')">
						<td style="display: table-cell; vertical-align: middle;"><b>관리자코드</b></td>
						<td colspan="3">
							<input type="text" name="admin_code" id="admin_code" value="${member.admin_code}" class="form-control" readonly /></td>
					</se:authorize>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" name="member_id" id="member_id" value="${member.member_id}" class="form-control" readonly /></td>
				</tr>
				<tr>
					<td style="display: table-cell; vertical-align: middle;"><b>비밀번호</b></td>
					<td colspan="3">
						<input type="password" id="member_pwd" name="member_pwd" class="form-control" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						...
						<div>
							<input type="text" id="sample6_address" name="member_addr" value="${member.member_addr}" class="form-control"
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" id="member_phone" name="member_phone" value="${member.member_phone}" class="form-control" /></td>
				</tr>
				<tr>
			...
			<div class="modal-body">
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								<input type="text" name="member_email1" id="member_email1" class="form-control"> <span class="input-group-btn">
