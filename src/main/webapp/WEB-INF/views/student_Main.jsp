...
<body>	
		...
		<div class = "col-sm-12 col-sm-offset-5">
			<input type="image" style="margin-right: 2%;" class="img-rounded  col-sm-3 hvr-grow-shadow" src="${pageContext.request.contextPath}/images/profile.JPG">
			<input type="image" style="margin-right: 2%;" class="img-rounded col-sm-3 hvr-grow-shadow" src="${pageContext.request.contextPath}/images/sookang.JPG">
		</div>
		</div>
	</div>
