	...
	<div class="navbar navbar-inner">
		<div class="container">
			<div class="navbar-header">
				...
				<se:authorize access="hasAnyRole('ROLE_STUDENT','ROLE_PROFESSOR','ROLE_ADMIN')">
              			<font style="font-size:9pt;color:#A1A1A1;">${LoginUser}님 환영합니다 &nbsp;|&nbsp;
              			<a href="${pageContext.request.contextPath}/logout">로그아웃</a></font> 
            	</se:authorize>
			</div>
			<div class="collapse navbar-collapse pull-right" id="main-menu">
				<ul class="nav">
					...
					<se:authorize access="hasAnyRole('ROLE_STUDENT')">
						...
						<ul class="firstlevel dropdown-menu sub-menu" style="display: none;">
							<li class="twolevel">
								<a href="${pageContext.request.contextPath}/collegeregister/viewstudent.htm">개인정보</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/collegeregister/record.htm">성적조회</a>
							</li>
							<li class="twolevel">
								<a href="${pageContext.request.contextPath}/collegeregister/register.htm">등록/장학</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/collegeregister/record.htm">신청</a>
							</li>
						</ul></li>
					<li class="dropdown fadeInDown animated d3">
						...
						<ul class="firstlevel dropdown-menu sub-menu" style="display: none;">
							...
							<li>
								<a href="${pageContext.request.contextPath}/requestcourse/preRegister.htm">예비 수강신청</a></li>
							<li>
								<a href="${pageContext.request.contextPath}/requestcourse/searchOtherTimetable.htm">타학생 예비 시간표 조회</a></li>
							<li>
					...
					<li class="dropdown fadeInDown animated d2">
						...
						<ul class="firstlevel dropdown-menu sub-menu" style="display: none;">
							...
							<li>
								<a href="${pageContext.request.contextPath}/qnanotice/qnanotice.htm">Q&A게시판</a>
							</li>
							<li>
				...
				<se:authorize access="hasAnyRole('ROLE_STUDENT','ROLE_PROFESSOR','ROLE_ADMIN')">
					<div class="dropdown">
						...
						<ul id="favoriteList" class="dropdown-menu"></ul>
					</div>
				</se:authorize>
